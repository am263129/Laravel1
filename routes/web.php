...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    // Videosongs manage
    Route::get('/api/admin/get/videosong', 'Admin\VideosongController@getAllVideoSongs');
    Route::post('/api/admin/delete/videosong', 'Admin\VideosongController@deleteVideoSong');
    Route::post('/api/admin/get/videosong/search', 'Admin\VideosongController@searchVideoSong');
    Route::post('/api/admin/new/videosong/upload', 'Admin\VideosongController@upload');
    Route::post('/api/admin/new/videosong/moviesubtitle', 'Admin\VideosongController@subtitleUpload');
    Route::post('/api/admin/new/videosong/customupload', 'Admin\VideosongController@customUploadVideoSongDetails');
    Route::get('/api/admin/get/videosong/{id}', 'Admin\VideosongController@getVideoSongDetails');
    Route::post('/api/admin/update/videosong', 'Admin\VideosongController@update');
    Route::post('/api/admin/update/videosong/available', 'Admin\VideosongController@availableVideoSong');
    Route::get('/api/admin/analysis/videosong/{id}', 'Admin\VideosongController@analysisVideoSong');
