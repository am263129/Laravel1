...
let routes = [
    ...
    },
    {
        name: 'movies-manage',
        path: '/movies/manage',
        component: require('./views/movies/movies-manage.vue')
    },
    {
        name: 'movie-api',
    ...
    {
        name: 'videosongs-manage',
        path: '/videosongs/manage',
        component: require('./views/videosongs/manage.vue')
    },
    {
        name: 'videosong-api-upload',
        path: '/videosongs/api-upload',
        component: require('./views/videosongs/api-upload.vue')
    },

    {
        name: 'videosong-custom-upload',
        path: '/videosongs/custom-upload',
        component: require('./views/videosongs/custom-upload.vue')
    },
    {
        path: '/videosong/edit/:id',
        name: 'videosong_edit',
        component: require('./views/videosongs/edit.vue')
    },
    {
        name: 'analysis-movie',
    ...
    //Video songs
    {
        name: 'manage-videosong',
        path: '/videosong/manage',
        component: require('./views/videosongs/manage.vue')
    },
    //Series
    {
        name: 'series-manage',
        path: '/series/manage',
        component: require('./views/series/manage.vue')
    },
    {
        name: 'series-api',
    ...
    },
    {
        ...
        name: 'withdrawals',
        component: require('./views/users/withdrawals.vue')
    },
    {
    ...
    },
    {
        path: '/ads/',
        name: 'ad-manager',
        component: require('./views/ads/manage.vue')
    },
