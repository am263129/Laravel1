...
<div class="analysis">
    ...
    <div class="dashboard" v-if="!spinner_loading">
        ...
        <div class="col-12 row">
            ...
            <div class="col-12 col-sm-6 mt-3" v-if="latest_views.length > 0">
                <div class="title p-2">Latest Epiosde Views</div>
                    ...
                    <div class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in latest_views" :key="index">
                                ...
                                <td>{{item.name}}</td>
                                <td>{{item.season_number}} / {{item.episode_number}}</td>
         ...
         <div class="col-12 col-sm-6 mt-3"  v-if="top_episode.length > 0">
                <div class="title p-2">Top Episode Views</div>
                <div class="table-responsive white">
                    <div class="table table-hover">
                        <thead>
                            <th>Episode Name</th>
                        ...
                        <tbody>
                            <tr v-for="(item, index) in top_episode" :key="index">
                                <td>{{item.name}}</td>
                                <td>{{item.season_number}} / {{item.episode_number}}</td>
                                <td>{{item.number}}</td>
                            </tr>
...
export default {
    ...
    mounted() {
        axios
            .get("/api/admin/analysis/series/" + this.$route.params.id)
            .then(response => {
                if (response.status === 200) {
                    ...
                    this.top_episode = response.data.data.top_episode;
