                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <div class="col-12">
                                <div class="alert alert-info" role="alert">
                                    ...
                                    <ol>
                                        <li>
                                            Re-name the video and image to same episode number and you can upload multiple episode in same time. <br>
                                        </li>
                        ...
                        <div v-if="cloud_type">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-12 col-sm-12">
                                    <input type="file" id="backdrop" name="backdrop" v-validate="'image'"
                                           @change="infoShow('backdrop','backropFileDetails')" class="inputfile"
                                           multiple>
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-group">
                                    <button class="btn btn-md btn-warning" v-if="!disabled_button"
                                            @click="MOVIEDB_API()">Upload
                                    </button>
