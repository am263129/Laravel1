<template>
    <div>
        <div class="k1_manage_table">
            <div class="title p-2">Video Song Custom Upload</div>
                                    ...
                                    <div class="form-group" v-if="upload_type_is == 'transcoding'">
                                        ...
                                        <div class="col-12">
                                            <input type="file" id="video" @change="infoShow('video','videoFileDetails')"
                                                   class="inputfile">
                                            <label id="videoLabel" for="video">Choose a video Song
                                                <br>
    ...
    export default {
        ...
        methods: {
            MOVIE_UPLOAD() {
                ...
                this.$validator.validateAll().then(result => {
                    if (result) {
                        ...
                        axios
                            .post("/api/admin/new/videosong/customupload", this.apiFormData)
                            .then(
                                response => {
            ...
            MOVIEVIDEO_S3(id) {
                ...
                // Store data
                axios.post("/api/admin/new/videosong/upload", this.uploadFormData, progress).then(
                    response => {
                        if (response.status === 200) {
