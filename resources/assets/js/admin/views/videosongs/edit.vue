<template>
    <div>
        ...
        <div class="k1_manage_table" v-if="!spinner_loading">
            <h5 class="title p-2">{{data.videosong.name}}</h5>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input v-validate="'required|max:30'" name="name" class="form-control"
                                   v-model="data.videosong.name" type="text" placeholder="Name"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input v-validate="'required|numeric|max:4'" name="year" class="form-control"
                                   v-model="data.videosong.year" type="text" placeholder="Years"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control" v-validate="'required'" name="category"
                                    v-model="data.videosong.category" id="category">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <textarea name="overview" class="form-control"
                                      v-model="data.videosong.overview" type="text" placeholder="Overview"> </textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-2">
                        ...
                        <div class="col-12">
                            <input v-validate="'required|decimal|max:10'" name="runtime" class="form-control"
                                   v-model="data.videosong.runtime" type="text"
                                   placeholder="Runtime"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input v-validate="'required|decimal|max:5'" name="rate" class="form-control"
                                   v-model="data.videosong.rate" type="text" placeholder="Rate"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input v-validate="'url|max:300'" name="youtube" class="form-control"
                                   v-model="data.videosong.youtube" type="text" placeholder="Trailer"
                            />
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            ...
                            <select class="form-control" v-validate="'required'" name="age" v-model="data.videosong.age"
                                    id="age">
                                <option>G</option>
                                <option>PG</option>
                                <option>PG-13</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            ...
                            <img :src="'/storage/posters/300_' + data.videosong.poster" id="posterFileImage" width="40%"
                                 v-if="data.videosong.cloud == 'local' || data.videosong.cloud == null">
                            <img :src="md_poster + data.videosong.poster" :alt="data.videosong.poster" width="300px"
                                 v-if="data.videosong.cloud == 'aws' ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            ...
                            <img :src="'/storage/backdrops/300_' + data.videosong.backdrop" id="backdropFileImage"
                                 width="100%" v-if="data.videosong.cloud == 'local' || data.videosong.cloud == null">
                            <img :src="md_backdrop + data.videosong.backdrop" :alt="data.videosong.backdrop" width="100%"
                                 v-if="data.videosong.cloud == 'aws' ">
                            ...
                            <div :id="'collapse'+ index" class="collapse show" :aria-labelledby="'heading' + index"
                                ...
                                <div class="card-body">
                                    <div class="form-group video-player">
                                        <video width="100%" controls v-if="data.videosong.type !== 'embed'">
                ...
                <div class="form-group m-3">
                    <div class="col-12 col-md-6">
                        <button class="btn btn-md btn-warning" @click="UPDATE(data.videosong.id)">UPDATE</button>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$store.dispatch('GET_CATEGORIES_BY_SORT', 'videosong');
        },
        ...
        watch: {
            ...
            data() {
                this.genres = this.data.videosong.genre.split(/[^\w\s]/g).map(String);
            }
        },

        mounted() {
            this.$store.dispatch("GET_VIDEOSONG", this.$route.params.id);
        ...
        methods: {
            UPDATE(id) {
                ...
                formData.append("id", this.data.videosong.id);
                formData.append("name", this.data.videosong.name);
                formData.append("year", this.data.videosong.year);
                formData.append("age", this.data.videosong.age);
                formData.append("genres", this.genres);
                formData.append("overview", this.data.videosong.overview);
                formData.append("runtime", this.data.videosong.runtime);
                formData.append("rate", this.data.videosong.rate);
                formData.append("youtube", this.data.videosong.youtube);
                formData.append("video_url", this.data.videosong.video_url);
                ...
                formData.append("category", this.data.videosong.category);
                ...
                this.$validator.validateAll().then(
                    result => {
                        if (result) {
                            ...
                            const _self = this;
                            axios
                                .post("api/admin/update/videosong", formData, progress)
                                .then(response => {
