...
let routes = [
    ...
    },
    {
        name: 'otp-login',
        path: '/app/opt-login',
        component: require('../views/' + themeName + '/auth/otp-login'),
        meta: {
            userNotAuth: true,
            title: 'OTP Signup'
        }
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/video-player/series-player'),
        meta: {
            userAuth: true,
            title: 'Series Player'
        }
    ...
    },
    {
        ...
        component: require('../views/' +
            themeName +
            '/control/video-player/movie-player'),
        meta: {
            userAuth: true,
            title: 'Movie Player'
        }
    ...
    {
        name: 'videosong-player',
        path: '/app/watch/videosong/:id',
        component: require('../views/' +
            themeName +
            '/control/video-player/videosong-player'),
        meta: {
            userAuth: true,
    ...
    },
    {
        ...
        component: require('../views/' +
            themeName +
            '/control/video-player/tv-player'),
        meta: {
            userAuth: true,
            title: 'Tv Player'
        }
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/payment-update'),
        meta: {
            userAuth: true,
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/billing-details'),
        meta: {
            userAuth: true,
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/adjust-subtitles'),
        meta: {
            userAuth: true,
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/viewing-history.vue'),
        meta: {
            userAuth: true,
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/support-inbox.vue'),
        meta: {
            userAuth: true,
            title: 'Support Inbox'
        }
    ...
    {
        name: 'my-referrals',
        path: '/app/setting/my-referrals',
        component: require('../views/' +
            themeName +
            '/control/setting/referrals.vue'),
        meta: {
            userAuth: true,
            title: 'My Referrals'
        }
    },
    {
        ...
        path: '/app/setting/payment-methods',
        component: require('../views/' +
            themeName +
            '/control/setting/payment-methods.vue'),
        meta: {
            userAuth: true,
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/support-request.vue'),
        meta: {
            userAuth: true,
...

    {
        ...
        component: require('../views/' +
            themeName +
            '/control/setting/device-activity.vue'),
        meta: {
            userAuth: true,
