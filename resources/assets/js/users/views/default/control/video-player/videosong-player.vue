                ...
                <div class="suggestion mb-5" v-if="data.suggestion !== null">
                    ...
                    <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                        ...
                        <slide v-for="(item,index) in data.suggestion" :key="index"
                            ...
                            <div class="movie" @click="CHANGE_VIDEOSONG(item.id)" style="cursor: pointer;">
...
<script>
    ...
    export default {
        ...
        computed: mapState({
            data: state => state.player.videosong_data,
        ...
        created() {
            ...
            if(this.$route.query.referral) {
                this.$store.dispatch("REFER", {id: this.$route.params.id, referral: this.$route.query.referral, type: 'videosong'});
            }

       },

        mounted() {
            this.$store.dispatch("LOAD_VIDEOSONG_PLAYER", this.$route.params.id);
        },
            ...
            data() {
                ...
                setTimeout(() => {
                    ...
                    if (jwplayer().getPosition().toFixed() == this.timeRequest) {
                        ...
                        axios.post('/api/v1/create/watch/videosong/recently', {
        ...
        methods: {
            CHANGE_VIDEOSONG(id) {
                ...
                if (this.$auth.isAuthenticated()) {
                    this.$store.dispatch("LOAD_VIDEOSONG_PLAYER", id);
                }
            },
            ...
            SEND_REPORT() {
                this.$validator.validateAll().then(result => {
                    if (result) {
                        ...
                        axios
                            .post("/api/v1/create/report/videosong", {
